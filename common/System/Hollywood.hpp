...
#else
constexpr u32 HW_BASE = 0xCD000000;
#endif
/**
...
#else
constexpr u32 HW_BASE_TRUSTED = 0xCD800000;
#endif
...
{
    return ReadU32(HW_BASE_TRUSTED + static_cast<u32>(reg));
}
...
{
    return ReadU32(HW_BASE + static_cast<u32>(reg));
}
...
{
    WriteU32(HW_BASE_TRUSTED + static_cast<u32>(reg), value);
}
...
{
    WriteU32(HW_BASE + static_cast<u32>(reg), value);
}
...
{
    MaskU32(HW_BASE_TRUSTED + static_cast<u32>(reg), clear, set);
}
...
{
    MaskU32(HW_BASE + static_cast<u32>(reg), clear, set);
}
...
{
    return ReadU16(HW_BASE_TRUSTED + static_cast<u32>(reg));
}
...
{
    return ReadU16(HW_BASE + static_cast<u32>(reg));
}
...
{
    WriteU16(HW_BASE_TRUSTED + static_cast<u32>(reg), value);
}
...
{
    WriteU16(HW_BASE + static_cast<u32>(reg), value);
}
...
{
    MaskU16(HW_BASE_TRUSTED + static_cast<u32>(reg), clear, set);
}
...
{
    MaskU16(HW_BASE + static_cast<u32>(reg), clear, set);
}
