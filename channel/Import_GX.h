...
IMPORT(0x80080138) //
void GXSetChanCtrl(
    GXChannelID chan, GXBool enable, GXColorSrc amb_src, GXColorSrc mat_src,
    u32 light_mask, GXDiffuseFn diff_fn, GXAttnFn attn_fn
);

IMPORT(0x800801DC) //
void GXInitTexObj(
    GXTexObj* obj, void* image, u16 width, u16 height, int format, int wrapS,
    int wrapT, bool mipmap
);
...
void GXSetTevColorIn(
    GXTevStageID stage, GXTevColorArg a, GXTevColorArg b, GXTevColorArg c,
    GXTevColorArg d
);

IMPORT(0x800813D8) //
void GXSetTevAlphaIn(
    GXTevStageID stage, GXTevAlphaArg a, GXTevAlphaArg b, GXTevAlphaArg c,
    GXTevAlphaArg d
);

IMPORT(0x80081418) //
void GXSetTevColorOp(
    GXTevStageID stage, GXTevOp op, GXTevBias bias, GXTevScale scale,
