...
IMPORT_DECL(0x80059B00);
IMPORT_DECL(0x80059B94);
IMPORT_DECL(0x8005A1CC);
IMPORT_DECL(0x8005E3A0);
IMPORT_DECL(0x8005F478);
IMPORT_DECL(0x8005F4BC);
IMPORT_DECL(0x80067700);
IMPORT_DECL(0x8006770C);
IMPORT_DECL(0x800673A8);
IMPORT_DECL(0x8006825C);
IMPORT_DECL(0x8006829C);
IMPORT_DECL(0x800682F8);
IMPORT_DECL(0x800683A8);
...
{
public:
    IMPORT_ATTR(0x8006829C) //
    ArcResourceAccessor();

    ~ArcResourceAccessor();

    IMPORT_ATTR(0x800682F8) //
    bool Attach(const void* arc, const char* root);

    IMPORT_ATTR(0x800683A8) //
...
{
public:
    IMPORT_ATTR(0x80067700) //
    u16 GetFrameSize() const;

    IMPORT_ATTR(0x8006770C) //
...
public:
    ...
    IMPORT_ATTR(0x8005F4BC) //
    virtual void __dt(int type);

    virtual bool Build(const void* brlyt, ArcResourceAccessor* arc);
    virtual AnimTransform*
    CreateAnimTransform(const void* brlan, ArcResourceAccessor* arc);
