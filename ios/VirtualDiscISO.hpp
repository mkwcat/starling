// VirtualDiscISO.hpp - ISO virtual disc
//   Written by Palapeli
//
...
class VirtualDiscISO : public VirtualDisc
{
public:
    VirtualDiscISO(const char* path, const char* path2);
    virtual ~VirtualDiscISO();
...
public:
    ...
    DI::DIError
    OpenPartition(u32 wordOffset, ES::TMDFixed<512>* tmdOut) override;
};
