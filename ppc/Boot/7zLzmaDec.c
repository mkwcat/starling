...
void LzmaDec_FreeProbs(CLzmaDec *p, [[maybe_unused]] ISzAllocPtr alloc)
{
  ISzAlloc_Free(alloc, p->probs);
  p->probs = NULL;
}

static void LzmaDec_FreeDict(CLzmaDec *p, [[maybe_unused]] ISzAllocPtr alloc)
{
