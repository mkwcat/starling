...
// Replaced
// TwmImport(0x8006C280) //
void OSReport(const char* format, ...);

TwmImport(0x8006FE70) //
    void __OSShutdownDevices(int param_1);

TwmImport(0x80070100) //
    void OSReturnToMenu();

TwmImport(0x8006B098) //
    u32 OSGetMEM1ArenaHi();

TwmImport(0x8006B0A0) //
    u32 OSGetMEM2ArenaHi();

TwmImport(0x8006B0A8) //
    u32 OSGetArenaHi();

TwmImport(0x8006B0B0) //
    u32 OSGetMEM1ArenaLo();

TwmImport(0x8006B0B8) //
    u32 OSGetMEM2ArenaLo();

TwmImport(0x8006B0C0) //
    u32 OSGetArenaLo();

TwmImport(0x8006E7B0) //
    u32 OSDisableInterrupts();

TwmImport(0x8006E7D8) //
    void OSRestoreInterrupts(u32 level);

TwmImport(0x8006EB40) //
    u32 __OSMaskInterrupts(u32 mask);

TwmImport(0x8006EBC0) //
...
TwmImport(0x8006FA34) //
    void OSInitMutex(OSMutex* mutex);

TwmImport(0x8006FA6C) //
    void OSLockMutex(OSMutex* mutex);

TwmImport(0x8006FB48) //
    void OSUnlockMutex(OSMutex* mutex);

TwmImport(0x8006FC7C) //
...
TwmImport(0x8006BF54) //
    void OSDumpContext(OSThread* context);

TwmImport(0x80070F88) //
    OSThread* OSGetCurrentThread();

TwmImport(0x80070F94) //
    bool OSIsThreadTerminated(OSThread* thread);

TwmImport(0x80070FC0) //
    s32 OSDisableScheduler();

TwmImport(0x80070FFC) //
    s32 OSEnableScheduler();

TwmImport(0x8007155C) //
    bool OSCreateThread(
        OSThread* thread, void* (*proc)(void*), void* param, void* stack,
        u32 stackSize, s32 priority, u16 attr
    );

TwmImport(0x800717C8) //
    void OSExitThread(void* exitCode);

TwmImport(0x800718AC) //
    void OSCancelThread(OSThread* thread);

TwmImport(0x80071A84) //
    bool OSJoinThread(OSThread* thread, void** val);

TwmImport(0x80071BC4) //
    s32 OSResumeThread(OSThread* thread);

TwmImport(0x80071FF0) //
    void OSSleepThread(OSThreadQueue* queue);

TwmImport(0x800720DC) //
    void OSWakeupThread(OSThreadQueue* queue);

TwmImport(0x800721F4) //
    void OSSleepTicks(OSTime ticks);

#define OSSleepMicroseconds(usec) OSSleepTicks(OSMicrosecondsToTicks(usec))

TwmImport(0x800722A8) //
    OSTime OSGetTime();

TwmImport(0x80072E7C) //
...
TwmImport(0x800783BC) //
    void VIInit();

TwmImport(0x80078904) //
    void VIWaitForRetrace();

TwmImport(0x80078DA0) //
    void VIConfigure(GXRenderModeObj* rmode);

TwmImport(0x80079888) //
    void VIFlush();

TwmImport(0x8007999C) //
    void VISetNextFrameBuffer(void* fb);

TwmImport(0x80079A08) //
    void VISetBlack(bool value);

TwmImport(0x80079B18) //
    u32 VIGetTvFormat();

TwmImport(0x80079B78) //
    u32 VIGetScanMode();

TwmImport(0x80079BD8) //
    u32 VIGetDTVStatus();

/*
 * SC library
 */
TwmImport(0x80096118) //
    bool SCFindU8Item(void* out, u32 id);

TwmImport(0x80096964) //
    u8 SCGetAspectRatio();
