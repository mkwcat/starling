...
#define SetGQR(_GQR, _VALUE)                                                   \
  do {                                                                         \
    u32 __value = _VALUE;                                                      \
    asm("mtspr 0x390 + " #_GQR ", %0" ::"r"(__value));                         \
  } while (0)
